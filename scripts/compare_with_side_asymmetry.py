...
SIDE_ASYMMETRY_FEATURES = [
    "white_cpl_mean",
    "black_cpl_mean",
    "wb_cpl_mean_diff",
    "white_best_move_ratio",
    "black_best_move_ratio",
    "wb_best_move_ratio_diff",
    "white_time_complexity_corr",
    "black_time_complexity_corr",
    "wb_time_complexity_corr_diff",
    "white_critical_time_lift",
    "black_critical_time_lift",
    "wb_critical_time_lift_diff",
]
...
def main() -> None:
    ...
    side_path = Path("data/engine/side_asymmetry_features_300.csv")
    output_path = Path("data/models/baseline_cognitive_side_comparison.json")
    ...
    if not side_path.exists():
        raise FileNotFoundError(f"Side asymmetry dataset not found: {side_path}")
    ...
    baseline_plus_cognitive_plus_side_features = baseline_plus_cognitive_features + [
        f for f in SIDE_ASYMMETRY_FEATURES if f in merged.columns
    ]

    experiments = {
        "baseline_only": baseline_only_features,
        "baseline_plus_cognitive": baseline_plus_cognitive_features,
        "baseline_plus_cognitive_plus_side_asymmetry": baseline_plus_cognitive_plus_side_features,
    }
